...
@section('main')
    <div class="main-content">
        <section class="section">
            @include('components.section-header', ['title' => 'Jurusan', 'index' => true])
            <div class="row">
                <div class="col-12">
                    @can('create-master-jurusan')
                        <a href="{{ route('jurusan.create') }}" class="btn btn-sm btn-primary mb-3"><i
                                class="fas fa-plus-circle"></i> Tambah
                        </a>
                    @endcan
                    <button type="button" class="btn btn-sm btn-success mb-3" id="sync-table-jurusan"><i
                            class="fas fa-sync"></i> Reload</button>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="table-jurusan" class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Nama</th>
...
@section('scripts')
    ...
    <script>
        let table = $("#table-jurusan");
        let btnSyncTable = $("#sync-table-jurusan");
