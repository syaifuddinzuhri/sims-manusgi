...
@section('main')
    <div class="main-content">
        <section class="section">
            @include('components.section-header', ['title' => 'Kategori', 'index' => true])
            <div class="row">
                <div class="col-12">
                    @can('create-journal-kategori')
                        <a href="{{ route('kategori.create') }}" class="btn btn-sm btn-primary mb-3"><i
                                class="fas fa-plus-circle"></i> Tambah
                        </a>
                    @endcan
                    <button type="button" class="btn btn-sm btn-success mb-3" id="sync-table-kategori"><i
                            class="fas fa-sync"></i> Reload</button>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="table-kategori" class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Nama</th>
...
@section('scripts')
    ...
    <script>
        let table = $("#table-kategori");
        let btnSyncTable = $("#sync-table-kategori");
