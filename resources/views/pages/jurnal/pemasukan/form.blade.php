...
@section('main')
    <div class="main-content">
        <section class="section">
            @include('components.section-header', ['title' => 'Pemasukan'])
            <a href="{{ route('pemasukan.index') }}" class="btn btn-sm btn-outline-dark mb-3"><i
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <form
                                action="{{ isset($is_editing) && $is_editing ? route('pemasukan.update', encryptData($data->id)) : route('pemasukan.store') }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="name" class="required">Nama Pemasukan</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="journal_category_id" id="kategori" class="form-control select2">
                                        ...
                                        @foreach (journalCategoryOptions('in') as $item)
