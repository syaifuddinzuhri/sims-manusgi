...
@section('main')
    <div class="main-content">
        <section class="section">
            @include('components.section-header', ['title' => 'Pemasukan', 'index' => true])
            <div class="row">
                <div class="col-12">
                    @can('create-journal-pemasukan')
                        <a href="{{ route('pemasukan.create') }}" class="btn btn-sm btn-primary mb-3"><i
                                class="fas fa-plus-circle"></i> Tambah
                        </a>
                    @endcan
                    <button type="button" class="btn btn-sm btn-success mb-3" id="sync-table-pemasukan"><i
                            class="fas fa-sync"></i> Reload</button>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="table-pemasukan" class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Tanggal</th>
...
@section('scripts')
    ...
    <script>
        let table = $("#table-pemasukan");
        let btnSyncTable = $("#sync-table-pemasukan");
