...
@section('main')
    <div class="main-content">
        <section class="section">
            @include('components.section-header', ['title' => 'Kenaikan Kelas', 'index' => true])
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="target-class">Tujuan Kelas</label>
                                    <select class="class-select select2" id="target-class" name="target_class"
                                        placeholder="Pilih kelas">
                                        @foreach (getClass() as $item)
                                            <option value="{{ $item['id'] }}">
                                                {{ $item['text'] }}</option>
