...
class DepartmentController extends Controller
{
    ...
    {
        $this->middleware('permission:read-master-jurusan', ['only' => 'index', 'show']);
        $this->middleware('permission:create-master-jurusan', ['only' => ['create', 'store']]);
        $this->middleware('permission:update-master-jurusan', ['only' => ['edit', 'update']]);
        $this->middleware('permission:delete-master-jurusan', ['only' => ['destroy']]);
