...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::insert([
            ...
            ['name' => 'create-transaksi-tunjakan', 'guard_name' => 'web'],
            ['name' => 'read-transaksi-tunjakan', 'guard_name' => 'web'],
            ['name' => 'update-transaksi-tunjakan', 'guard_name' => 'web'],
            ['name' => 'delete-transaksi-tunjakan', 'guard_name' => 'web'],
